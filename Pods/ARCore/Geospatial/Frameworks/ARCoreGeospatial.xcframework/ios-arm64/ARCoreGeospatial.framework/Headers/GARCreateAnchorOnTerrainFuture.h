 ...
 * See the
 * <a href="https://developers.google.com/ar/develop/ios/geospatial/anchors#terrain-anchors">Terrain
 * anchors developer guide</a> for more information.
 */
@interface GARCreateAnchorOnTerrainFuture : GARFuture
...
/**
 * The result terrain anchor state of the async operation, or a default value if the operation isn't
...
/// @cond
/** Instantiated by
 * `GARSession#createAnchorcreateAnchorWithCoordinate:altitudeAboveTerrain:eastUpSouthQAnchor:completionHandler:error:`.
 */
